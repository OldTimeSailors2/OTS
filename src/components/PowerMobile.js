...
const SIZES = {
  s: {
    ...
    ticketsWrapper: "relative h-[18px]",
    ticketsLink: "absolute inset-0 items-center justify-center text-beige w-[45%]",
    ticketsSvg: "w-full h-[35px] z-10",
    ticketsText: "relative font-txt justify-center text-center text-[16px] -top-[29px] z-20 uppercase",
    ticketsImgSrc: null,
    ...
    videoCls: "w-[76%] h-[74%] absolute top-[1px] left-[27px] object-cover rounded-sm hover:opacity-100 [&::-webkit-media-controls]:opacity-0 hover:[&::-webkit-media-controls]:opacity-100 [&::-webkit-media-controls]:transition-opacity",
    videoFrameOuter: "absolute inset-0 z-10 -top-[45px] left-[5px]",
    videoFrameW: 215, videoFrameH: 166, videoFrameCls: "w-[215px] h-[166px]",
    photo2Wrap: "absolute -right-2 -top-4 w-[130px] h-[130px]",
    photo2Cls: "w-[130px] h-[130px]", photo2W: 120, photo2H: 120,
    mediaBottomWrap: "relative h-[200px] bottom-8",
    photo1Container: "absolute left-[34px] -top-[71.5px] w-1/2 z-20",
    photo1Cls: "w-[143px] h-[145px] z-10", photo1W: 145, photo1H: 145,
    arrowSrc: "/assets/beigeArrow.webp",
    arrowWrap: "relative",
    arrowImgCls: "absolute right-8 -bottom-12 w-[145px] h-[40px]", arrowW: 145, arrowH: 40,
    ...
    photo3Cls: "w-[156px] h-[156px]", photo3W: 156, photo3H: 154,
  ...
  m: {
    ...
    ticketsWrapper: "relative -left-[1.05px]",
    ticketsLink: "absolute inset-0 text-beige pt-1",
    ticketsSvg: null,
    ticketsText: null,
    ticketsImgSrc: "/assets/buyTickets.png",
    ticketsImgW: 161.56, ticketsImgH: 26.44,
    ...
    videoInner: "absolute inset-0 flex items-center justify-center z-20",
    videoCls: "w-[187.97px] h-[106.42px] absolute top-[41px] left-[11px] object-cover rounded-sm hover:opacity-100 [&::-webkit-media-controls]:opacity-0 hover:[&::-webkit-media-controls]:opacity-100 [&::-webkit-media-controls]:transition-opacity",
    videoFrameOuter: "absolute inset-0 z-10",
    videoFrameW: 239, videoFrameH: 148, videoFrameCls: "transform-gpu w-[239px] h-[148px]",
    photo2Wrap: "absolute -right-[19.20px] -top-[20px] w-[160px] h-[130px]",
    photo2Cls: "w-[148.54px] h-[148.54px] shadow-[3px_3px_3px_rgba(0,0,0,0.3)]", photo2W: 150, photo2H: 150,
    mediaBottomWrap: "relative h-[200px]",
    photo1Container: "absolute left-[47.91px] -top-[88px] z-20",
    photo1Cls: "w-[154.33px] h-[155.33px] z-10 shadow-[3px_3px_3px_rgba(0,0,0,0.3)]", photo1W: 170, photo1H: 170,
    arrowSrc: "/assets/beigeArrow.png",
    arrowWrap: "relative",
    arrowImgCls: "w-[160px] h-[50px] absolute right-[20px] -bottom-[60px]", arrowW: 160, arrowH: 50,
    moreGigsText: null,
    showMoreGigs: false,
    photo3Wrap: "absolute -right-[4px] bottom-[80px] w-[187px] h-[187px] z-10",
    photo3Cls: "w-full h-auto", photo3W: 400, photo3H: 400,
  ...
  l: {
    ...
    ticketsWrapper: "relative h-[18px] pb-8",
    ticketsLink: "absolute inset-0 items-center justify-center text-beige w-[55%] left-4",
    ticketsSvg: "w-[80%] h-[35px] z-10",
    ticketsText: "relative font-txt uppercase justify-center text-[20px] -top-[32px] z-20 w-[80%] text-center",
    ticketsImgSrc: null,
    ...
    videoInner: "absolute inset-0 flex items-center justify-center z-20",
    videoCls: "w-[77%] h-[98%] absolute -top-[7px] left-[33px] object-cover rounded-sm hover:opacity-100 [&::-webkit-media-controls]:opacity-0 hover:[&::-webkit-media-controls]:opacity-100 [&::-webkit-media-controls]:transition-opacity",
    videoFrameOuter: "absolute inset-0 z-10 -top-[58px] left-[5px]",
    videoFrameW: 290, videoFrameH: 209, videoFrameCls: "w-[285px] h-[209px]",
    photo2Wrap: "absolute -right-[10px] -top-[25px] w-[175px] h-[130px]",
    photo2Cls: "w-[170px] h-[180px] shadow-2xl", photo2W: 180, photo2H: 180,
    mediaBottomWrap: "relative h-[200px]",
    photo1Container: "absolute left-[25px] bottom-[78px] w-1/2 z-20",
    photo1Cls: "w-[195px] h-[195px] z-10", photo1W: 185, photo1H: 185,
    arrowSrc: "/assets/beigeArrow.webp",
    arrowWrap: "relative",
    arrowImgCls: "w-[180px] h-[55px] absolute right-[45px] -bottom-[65px]", arrowW: 180, arrowH: 55,
            ...
            <div className={s.venueCard}>
              <div className={s.venueCardInner}>
                ...
                <div className="mt-0.5">
                  ...
                  <Link href={eventURL}>
                    <p className={`text-darkBlue mt-1 underline font-titles ${s.venueLinkText}`}>contact the venue for + info</p>
                  </Link>
                </div>
              </div>
            </div>
      ...
      <div className={s.mediaWrap}>
        <div className={s.mediaTopWrap}>
          ...
          <div className={s.photo2Wrap}>
            <Image src="/assets/powerPhoto4.jpg" alt="Musicians" width={s.photo2W} height={s.photo2H} className={s.photo2Cls} loading="lazy" />
          </div>
        </div>
        ...
        <div className={s.mediaBottomWrap}>
          <div className={s.photo1Container}>
            <Image src="/assets/powerPhoto1.webp" alt="Performance" width={s.photo1W} height={s.photo1H} className={s.photo1Cls} loading="lazy" />
            <div className={s.arrowWrap} onClick={() => router.back()} role="button" tabIndex={0}>
              <Image src={s.arrowSrc} alt="More gigs" width={s.arrowW} height={s.arrowH} className={s.arrowImgCls} loading="lazy" />
              {s.showMoreGigs && <p className={s.moreGigsText}>more gigs</p>}
            </div>
          </div>

          <div className={s.photo3Wrap}>
            <Image src="/assets/powerPhoto3.webp" alt="Crowd" width={s.photo3W} height={s.photo3H} className={s.photo3Cls} loading="lazy" />
          </div>
        </div>
        ...
        <Image src="/assets/shipDrawing.webp" alt="Background drawing" width={s.shipW} height={s.shipH} className={s.shipCls} loading="lazy" />
      </div>
    </>
  );
};
