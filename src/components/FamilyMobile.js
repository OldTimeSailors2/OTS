...
const stylesByVariant = {
  ...
  tablet: {
    ...
    venueText: "text-beige font-txt leading-tight text-[15px]",
    venueLink: "text-beige mt-1 font-titles underline text-[16px]",
    infoWrap: "",
    infoRow: "flex items-center gap-2 text-darkBlue font-txt",
    iconClass: "text-[13px]",
    infoText: "text-[12px] font-bold",
    ctaWrap: "relative h-[8vh] mt-2 -left-[2.5vw]",
    ctaLink: "absolute inset-0 items-center justify-center text-beige w-[65%] left-4",
    ...
    backText: "absolute inset-0 font-titles text-beige w-3/4 text-center mx-auto top-[40px] text-[50px]",
