...
const stylesByVariant = {
  s: {
    ...
    venueText: "text-beige text-[7px] leading-tight font-txt",
    venueLink: "text-beige text-[8px] mt-1 underline font-titles",
    infoWrap: "pt-2",
    infoRow: "flex items-center gap-2 text-darkBlue font-bold pl-2",
    iconClass: "text-[10px]",
    infoText: "text-[10px] font-txt",
    ctaWrap: "relative pt-2 pb-2",
    ctaLink: "absolute items-center justify-center text-beige pl-2",
    ...
    backText: "absolute inset-0 font-times font-titles text-beige left-[25px] top-[13px] text-[20px]",
  ...
  m: {
    ...
    infoText: "text-[10px] font-txt",
    ctaWrap: "relative pt-2 pb-2",
    ctaLink: "absolute items-center justify-center text-beige pl-5",
    ctaSvg: "w-[10em] h-[35px] z-10",
    ctaText: "relative font-txt justify-center text-center text-[16px] -top-[29px] z-20 uppercase",
  ...
  l: {
    ...
    venueText: "text-beige text-[9px] leading-tight font-txt",
    venueLink: "text-beige text-[9px] mt-1 font-titles underline",
    infoWrap: "",
    infoRow: "flex items-center gap-2 text-darkBlue font-txt",
    iconClass: "text-[13px]",
    infoText: "text-[12px]",
    ctaWrap: "relative h-[5vh] mt-2 -left-[2.5vw]",
    ctaLink: "absolute inset-0 items-center justify-center text-beige w-[70%] left-4",
    ...
    backText: "absolute inset-0 font-titles text-beige left-[50px] top-5 text-[24px]",
      ...
      <div className={styles.panel}>
        <div className={styles.headingWrap}>
          <h1 className="font-titles leading-none">
            <span className={variant === "l" ? "text-darkBlue text-2xl" : "text-darkBlue text-xl"}>old time sailors </span>
            <span className={variant === "l" ? "text-lightRed text-2xl" : "text-lightRed text-xl"}> at</span>
            <br />
            <span className={variant === "l" ? "text-lightRed text-2xl" : "text-lightRed text-xl"}>{event}</span>
          </h1>
          <p className={variant === "l" ? "text-darkBlue text-xl font-txt upercase" : "text-darkBlue text-md font-txt"}>{location}</p>
        </div>

        {variant === "l" && <div className="border-more-dashed pb-2" />}
