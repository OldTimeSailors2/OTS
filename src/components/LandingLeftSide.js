...
const LandingLeftSide = () => {
  ...
  // ✅ blur seguro (solo si existe blurDataURL)
  const blurbTitleBlur =
    typeof BlurbTitle === "object" && BlurbTitle?.blurDataURL
      ? BlurbTitle.blurDataURL
      : undefined;
            ...
            <ModalComponent.ModalContent>
              <ModalComponent.ModalHeader className="pb-0 iphone-3:px-7 xl:px-8">
                <Image
                  ...
                  alt="Blurb title"
                  className="h-auto"
                  placeholder={blurbTitleBlur ? "blur" : "empty"}
                  blurDataURL={blurbTitleBlur}
                />
