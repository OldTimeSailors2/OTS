...
const LandingLeftSide = () => {
  ...
  return (
    <div className="flex justify-between ">
      <div
        className={`flex flex-col items-center justify-center   xl:ml-1 1xl:ml-1.5 1xxl:ml-1 fullHD:ml-4 2k:ml-6    xl:mt-[170px] 1xxl:mt-[190px] 4xl:mt-[210px]  fullHD:mt-[270px] 2k:mt-[380px] 4k:mt-[540px]  ${isSafari
      ...
      >
        <Image
          ...
          height={100}
          alt="Text image"
          className={`self-center xl:w-[130px] xl:h-auto 1xxl:w-[150px] 4xl:w-[170px] fullHD:w-[200px] 2k:w-[280px] 4k:w-[400px] ${isSafari
