      ...
      <div className="relative -bottom-[170px]">
        <div className="relative w-full h-full my-[250px]">
          <div className="border-[3px] border-beige p-2 relative w-[1100px] -right-[100px] -top-[310px]">
            ...
            <div className="space-y-6 pl-[45px]">
              <div className="flex flex-row gap-5">
                <div className="space-y-3">
                  {[
                    ...
                    <div key={`${idx}-${text}`} className="flex items-center gap-2 text-beige font-txt leading-tight">
              ...
              <div className="text-xl pr-[150px] pb-7 text-beige font-txt text-left leading-10">
                ...
                <p className="leading-relaxed [&:not(:last-child)]:mb-0">
                  &apos;Rock and row&apos; with our 21 strong crew of rebellious musicians as the navigate a voyage through the thrashing seas of Hevay
                  Metal and Hard Rock on a genre bending adventure into uncharted waters, join in the Wall of Death and thrash it out with your
                  shipmates.
                </p>
                <p className="leading-relaxed [&:not(:last-child)]:mb-0">
          ...
          <div className="relative top-[15px]" onClick={() => router.back()} role="button" tabIndex={0}>
            <Image src="/assets/beigeArrow.webp" alt="More gigs" width={470} height={150} className="absolute left-[10px] top-[25px] w-[450px] h-[110px]" loading="lazy" />
