        ...
        <div className="relative w-screen h-full ">
          ...
          <div className="absolute right-[5px] -bottom-[500px]">
            <Image
              ...
              width={600}
              height={500}
              className="w-[400px] h-[350px] brightness-[78%] contrast-[91%]"
              loading="lazy"
            />
          </div>
          ...
          <div className="absolute inset-0 top-[29em] left-[55px] z-40">
            <video
              ...
              className="object-cover w-[540px] h-[240px] border-darkBlue border-[10px] rounded-sm shadow-gray-500 shadow-[2px_-2px_5px_rgba(0,0,0,0.3)]
          ...
          <div className="relative -top-[6em]" onClick={() => router.back()} role="button" tabIndex={0}>
            <Image
