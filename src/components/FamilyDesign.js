...
export const FamilyDesign = ({ data }) => {
    ...
    return (
        <>
            <div className="w-full h-full relative top-[3em]">
                <div className="w-[50%] ml-[7em] border-[3px] relative border-darkBeige">
                    <div className="text-left px-10 border-b-[3px] border-darkBeige border-dashed">
                        ...
                        <div className="absolute w-[45%] top-[10%] left-[85%] z-1">
                            <div className="bg-darkBlue p-6 rounded-3xl">
                                <h3 className="text-lightRed text-4xl font-titles leading-none">
                                    more about
                                    <br />
                                    the venue
                                </h3>
                                <div className="mt-0.5 tracking-wide">
                                    <p className="text-beige text-1xl font-txt leading-tight">
                                        {venueInfo}
                                    </p>
                                    <Link href={eventURL}>
                            ...
                            <div className="mt-2 px-10">
                                {[
                                    ...
                                    <div key={text} className="flex items-center gap-2 text-darkBlue font-txt">
                                        ...
                                        <span className="text-[15px] font-txt">{text}</span>
                                    </div>
                                ))}
                            </div>

                            <div className="">
                                <Link className="relative left-4 inset-0  items-center justify-center  text-beige " href={ticketsURL} target="_blank" onClick={() => ClickPixel('BuyTicket')}>
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 358.62 137.01"
                                        preserveAspectRatio="none"
                                        className="w-[100%] h-[80px] z-10"
                                    >
                                        <path
                                            fill="#db3a57"
                                    ...
                                    <p className="absolute font-txt text-[25px] uppercase top-[20px] w-[100%] text-center">buy tickets</p>
                                </Link>
                            </div>
                        </div>

                        <p className="mx-auto px-auto p-2 text-[15px] text-darkBlue font-txt ">
                ...
                <div className="absolute right-[10em] top-[8em] z-10">
                    <Image src="/assets/familyPhoto1.webp" alt="Performance" width={70} height={70} className="w-[270px] h-[270px] " loading="lazy" />
                </div>
                {/* Photo 2 */}
                <div className="absolute right-[95px] top-[225px] z-20">
                    <Image src="/assets/familyPhoto2.webp" alt="Musicians" width={50} height={20} className="w-[50px] " loading="lazy" />
                </div>
                {/* Photo 3 */}
                <div className="absolute left-[500px] top-[550px] z-30">
                    <Image src="/assets/familyPhoto3.webp" alt="Crowd" width={50} height={60} className="w-[50px]" loading="lazy" />
                </div>
