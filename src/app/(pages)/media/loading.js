...
const Loading = () => {
  return (
    <div className="relative w-screen h-screen">
      ...
      {/* Content */}
      <div className="w-full h-full pt-[77px] xs:pt-[92px]  2xl:pt-[172px] 2k:pt-[204px] 4k:pt-[268px] p-[17.5px] xl:p-[28px] 2k:p-[52px] 4k:p-[64px] flex justify-center items-center relative">
